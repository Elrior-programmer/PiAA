...
Projekt dotyczy analizy efektywności trzech algorytmów 
...
Merge sort jest algorytmem opartym na „dziel i zwyciężaj". 
...
Quicksort również wykorzystuje „dziel i zwyciężaj". 
...
Każdy rekord reprezentowany był przez obiekt
MovieRating zawierający id filmu, tytuł 
oraz ocenę.
...
Wykorzystano w tym celu funkcję is\_sorted, która sprawdza czy elementy tablicy 
...
Intel Core i5-620 oraz 8~GB pamięci RAM DDR3 
